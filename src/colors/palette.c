...
/*   Updated: 2024/12/02 12:49:36 by mvigara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_palette *init_palettes(void) 
{
    ...
    array[3] = (t_palette){7, 1, {0x000080FF, 0x4B0082FF, 0x800080FF, 
        0xDB7093FF, 0xADD8E6FF, 0xFFD700FF, 0xFFFFFFFF}};
    array[4] = (t_palette){7, 1, {0x000066FF, 0x4169E1FF, 0xB8860BFF, 
        0xFF8C00FF, 0xE6E6FAFF, 0xFFD700FF, 0xFFFFFFFF}};
    array[5] = (t_palette){7, 1, {0x000033FF, 0x003366FF, 0x0099CCFF, 

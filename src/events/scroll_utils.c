...
/*   Updated: 2025/04/20 15:21:47 by mvigara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_fractal_shift(t_fractol *f, int mx, int my,
		t_complex mouse_pos)
{
	f->shift_x = mouse_pos.re - (mx - FRACT_SIZE / 2.0) * f->zoom / FRACT_SIZE;
	f->shift_y = mouse_pos.im - (my - FRACT_SIZE / 2.0) * f->zoom / FRACT_SIZE;
}
